    ...
    return (
      <div className="filter-tab">
        ...
        <div className="filter-tab__sort">
          ...
          <button className="filter-tab__sort_btn button-dark filter-tab__sort_direction" onClick={this.onClickToggleSortDirection}>
            <div className={`filter-tab__sort_direction_${SortingDirectionEnum[this.state.sortDirection]}`} />
          </button>
        </div>
      </div >
    );

...
describe('MovieInfoHeader', () => {
    ...
    it('should change movie poster path if movie poster can not be found ', () => {
        const movie = {
            ...MOVIE,
            poster_path: '123'
        }
        ...
        fireEvent.error(moviePoster);
        expect(moviePoster.getAttribute('src')).toEqual('../../assets/images/no-image.png');
    });

    it('should change movie poster path to default if no path is provided', () => {
        const movie = {
            ...MOVIE,
            poster_path: ''
        }
